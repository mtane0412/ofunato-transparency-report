            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div>
                ...
                <dd className="mt-1 text-lg font-bold text-gray-900">
                  {formatThousandYen(latestFinancial.nationalSubsidy)}
                </dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-gray-500">
                ...
                <dd className="mt-1 text-lg font-bold text-gray-900">
                  {formatThousandYen(latestFinancial.prefecturalSubsidy)}
                </dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-gray-500">地方債</dt>
                <dd className="mt-1 text-lg font-bold text-gray-900">
                  {formatThousandYen(latestFinancial.localBond)}
                </dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-gray-500">その他</dt>
                <dd className="mt-1 text-lg font-bold text-gray-900">
                  {formatThousandYen(latestFinancial.other)}
                </dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-gray-500">一般財源</dt>
                <dd className="mt-1 text-lg font-bold text-gray-900">
                  {formatThousandYen(latestFinancial.generalRevenue)}
                </dd>
              </div>
              <div>
                <dt className="text-sm font-medium text-gray-500">
                ...
                <dd className="mt-1 text-lg font-bold text-gray-900">
                  {formatThousandYen(latestFinancial.totalCost)}
                </dd>
              </div>
            </div>
            <div className="pt-4 border-t border-gray-200">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-lg font-bold text-gray-900">
                    {formatThousandYen(latestFinancial.personnelCost)}
                  </dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">
